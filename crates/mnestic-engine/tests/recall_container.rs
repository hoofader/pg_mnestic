...
async fn container_filter_scopes_recall() {
    ...
    let a = engine
        .recall_scoped(tenant, "u", &["proj-a".to_string()], "fact", 10, None)
        .await
        .unwrap();
    ...
    let b = engine
        .recall_scoped(tenant, "u", &["proj-b".to_string()], "fact", 10, None)
        .await
        .unwrap();
    ...
    let none = engine
        .recall_scoped(tenant, "u", &["proj-a".to_string(), "proj-b".to_string()], "fact", 10, None)
        .await
        .unwrap();
